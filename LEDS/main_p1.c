...
#define LED_OF_state 0

//Para contar tiempo
void delay_ms (unsigned long time_ms)
{
    unsigned long u;
    for(u = 0; u < time_ms * 450; u++) //Calculo aproximado para una CPU de 4 Mhz
    {
        asm("NOP");
    }
}
...
int main(void) {
    //Fosc = Fpri*M/(N1*N2) => 4Mhz * 40/(2*2) = 80Mhz
    //Fcpu = Fosc/2 = 80Mhz/2 = 40Mhz
    ...
    //LED_ROJO = 0;           //Pin RB3 (D1)
    LED_VERDE = 1;          //Pin RA0 (D2)
    LED_VERDE2 = 1;         //Pin RA1 (D2)
